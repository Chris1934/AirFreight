...
// AIRFreight: Programm zum Überprüfen von Seriennummern bei Luftfracht - Graphische Version
// Version 4 (GUI)
...
void fSet(GtkWidget *widget, gpointer data) {
    ...
    if(fName.find(".csv") == string::npos) {
        ...
        hasSafe = checkSafe();
        if(hasSafe) {
            markup += "<span color=\"purple\">Sicherungsdatei gefunden, wird bei Bestätigung wiederhergestellt";
        } else {
